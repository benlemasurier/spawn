  ...
  services.polybar = {
    ...
    config = {
      ...
      "bar/default" = {
        ...
        modules-right =
          if isLaptop then
            "pulseaudio-control filesystem network battery tray date"
          else
            "pulseaudio-control filesystem tray date";
      }
